...
| P1 | suspend-policy | power | hybrid | hyprstate | systemd-logind, systemd suspend targets | high | hyprstate owns lid/idle grace, lock-before-suspend, and cancellation; hypr-DE's hypridle listener may only request via the suspend-request file; logind performs suspension. |
